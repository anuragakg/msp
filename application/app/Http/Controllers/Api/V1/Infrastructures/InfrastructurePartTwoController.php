...
use App\Services\Infrastructures\InfrastructuredevelopmentPartTwoService;

class InfrastructurePartTwoController extends ApiController
{
    protected $service;

    public function __construct(InfrastructuredevelopmentPartTwoService $InfrastructuredevelopmentPartTwoService)
    {
        $this->service = $InfrastructuredevelopmentPartTwoService;
    }
