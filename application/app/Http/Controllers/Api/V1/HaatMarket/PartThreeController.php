...
use App\Http\Resources\Api\HaatMarketThreeResource as ApiResource;
use App\Services\HaatMarketThreeService;

class PartThreeController extends ApiController
{

    protected $service;

    public function __construct(HaatMarketThreeService $haatMarketThreeService)
    {
        $this->service = $haatMarketThreeService;
    }
