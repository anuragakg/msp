...
use App\Http\Resources\Api\HaatMarketFourResource as ApiResource;
use App\Services\HaatMarketFourService;

class PartFourController extends ApiController
{

    protected $service;

    public function __construct(HaatMarketFourService $haatMarketFourService)
    {
        $this->service = $haatMarketFourService;
    }
