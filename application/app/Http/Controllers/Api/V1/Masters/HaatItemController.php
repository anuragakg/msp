...
use App\Http\Resources\Api\Masters\HaatBazaarItemResource as ApiResource;
use App\Services\Masters\HaatItemService;


class HaatItemController extends ApiController
{
    protected $service;

    public function __construct(HaatItemService $HaatItemService)
    {
        $this->service = $HaatItemService;
    }
    ...
    public function getHaatitemListing(Request $request)
    {
        //$this->checkPermission('role_view');
       ...
       // try {
            ...
            $items = $this->service->getHaatitemListing($request);
            $items = ApiResource::collection($items);
            $json_data = array(
