...
class MfpProcurementGenerateSanctionResource extends JsonResource
{
    /**
    ...
    {   
        $consolidation=$this->getConsolidation;
        ...
        return [
            ...
            /*'transaction_id' => $consolidation->transaction_id,
            'transaction_date' => date('d/m/Y',strtotime($consolidation->transaction_date)),*/
