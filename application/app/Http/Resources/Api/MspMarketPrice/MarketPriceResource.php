...
class MarketPriceResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'approver_name'=>isset($this->getStatusChangedBy->user_name)?$this->getStatusChangedBy->user_name:null,
            'submission_date'=>$this->submission_date?date('d/m/Y',strtotime($this->submission_date)):null,
            'approval_date'=>date('d/m/Y',strtotime($this->status_update_date)),
        ];
    }
}
