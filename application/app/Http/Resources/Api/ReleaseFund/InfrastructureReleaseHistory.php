...
use App\Models\Infrastructures\Infrastructure_Development_fund_released;
use App\Http\Resources\Api\UserResource;

use Illuminate\Http\Resources\Json\JsonResource;

class InfrastructureReleaseHistory extends JsonResource
{
    /**
    ...
    {
        $history=Infrastructure_Development_fund_released::where(['consolidated_id'=>$consolidated_id,'assigned_to'=>$assigned_to])->first();
