...
use App\Models\Masters\Occupation as ServiceModel;
...
class OccupationService extends Service
{
    ...
    public function validateCreate($data)
    {
        ...
        [
            'title.required' => 'Please provide Occupation',
            'title.alpha_spaces' => 'Occupation name may only contain letters and spaces',
            'title.unique' => 'The occupation has already been taken'
        ]);
    }
    ...
    public function getOccupationByName($occupation)
    {
        return ServiceModel::whereTitle($occupation)->first();
    }
