...
use App\Models\Masters\MemberRelation as ServiceModel;
...
class MemberRelationService extends Service
{
    ...
    public function validateCreate($data)
    {
        ...
        [
            'title.required' => 'Please provide member relation',
            'title.alpha_spaces' => 'Relation name may only contain letters and spaces',
            'title.unique' => 'The member relation has already been taken'
        ]);
    }
    ...
    public function getMemberRelationByName($memberRelation)
    {
        return ServiceModel::whereTitle($memberRelation)->first();
    }
