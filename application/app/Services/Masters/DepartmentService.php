...
use App\Models\Masters\Department as ServiceModel;
...
class DepartmentService extends Service
{
    ...
    public function createItem($data)
    {
        ...
        $item->save();
        //==Add User Activity
        $activity='added department master  '.$data['title'];
        $module='master';
    ...
    public function updateItem($id, $data)
    {
        ...
        $item->save();
        //==Add User Activity
        $activity='updated department master  '.$data['title'];
        $module='master';
        $this->addUserActivity($activity,$module);
        return $item;
    }
    ...
    public function validateCreate($data)
    {
        ...
        [
            'title.required' => 'Please provide department',
            'title.alpha_spaces' => 'Department name may only contain letters and spaces',
            'title.unique' => 'The department has already been taken'
        ]);
    }
    ...
    {
        return ServiceModel::whereTitle($department)->first();
    }
