...
use App\Models\Masters\FinancialYear as ServiceModel;
use Illuminate\Support\Facades\Validator;
use Illuminate\Validation\Rule;

class FinancialYearService extends Service
{
    /**
    ...
    public function createItem($data)
    {
        ...
        $item->save();
        //==Add User Activity
        $activity='added financial master  '.$data['title'];
        $module='master';
    ...
    public function updateItem($id, $data)
    {
        ...
        $item->save();
         //==Add User Activity
        $activity='updated financial master  '.$data['title'];
        $module='master';
        $this->addUserActivity($activity,$module);
        return $item;
    }
    ...
    public function validateCreate($data)
    {
        ...
        return Validator::make($data, [
            'title' => [
                'required', 'regex:/^[0-9]{4}-[0-9]{4}$/',
                Rule::unique($model->getTable())
            ]
        ],
        [
            'title.required' => 'Please provide financial year',
            'title.regex' => 'Please provide financial year in this format (2010-2011)',
            'title.unique' => 'The financial year has already been taken'
        ]);
    }
