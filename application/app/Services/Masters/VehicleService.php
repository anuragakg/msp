...
use App\Models\Masters\Vehicle as ServiceModel;
...
class VehicleService extends Service
{
    ...
    public function validateCreate($data)
    {
        ...
        [
            'title.required' => 'Please provide vehicle',
            'title.alpha_spaces' => 'Vehicle name may only contain letters and spaces',
            'title.unique' => 'The vehicle has already been taken'
        ]);
    }
    ...
    public function getVehicleByName($vehicle)
    {
        return ServiceModel::whereTitle($vehicle)->first();
    }
