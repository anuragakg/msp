...
use App\Models\Masters\PhoneType as ServiceModel;
use Illuminate\Support\Facades\Validator;
use Illuminate\Validation\Rule;

class PhoneTypeService extends Service
{
    /**
    ...
    public function validateCreate($data)
    {
        ...
        [
            'title.required' => 'Please provide Phone Type',
            'title.alpha_spaces' => 'Phone Type name may only contain letters and spaces',
            'title.unique' => 'The phone type has already been taken'
        ]);
    }
    ...
    public function getPhoneTypeByName($phoneType)
    {
        return ServiceModel::whereTitle($phoneType)->first();
    }
