...
use App\Models\Masters\Equipment as ServiceModel;
...
class EquipmentService extends Service
{
    ...
    public function createItem($data)
    {
        ...
        $item->save();
        //==Add User Activity
        $activity='added equipment master  '.$data['title'];
        $module='master';
    ...
    public function updateItem($id, $data)
    {
        ...
        $item->save();
        //==Add User Activity
        $activity='updated equipment master  '.$data['title'];
        $module='master';
        $this->addUserActivity($activity,$module);
        return $item;
    }
    ...
    public function validateCreate($data)
    {
        ...
        [
            'title.required' => 'Please provide equipment name',
            'title.alpha_spaces' => 'equipment status name may only contain letters and spaces',
            'title.unique' => 'The equipment name has already been taken'
        ]);
    }
    ...
    public function getEquipmentName($name)
    {
        return ServiceModel::whereTitle($name)->first();
    }
