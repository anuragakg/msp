...
use App\Models\Masters\Education as ServiceModel;
...
class EducationService extends Service
{
    ...
    public function createItem($data)
    {
        ...
        $item->save();
        //==Add User Activity
        $activity='added education master  '.$data['title'];
        $module='master';
    ...
    public function updateItem($id, $data)
    {
        ...
        $item->save();
        //==Add User Activity
        $activity='updated education master  '.$data['title'];
        $module='master';
        $this->addUserActivity($activity,$module);
        return $item;
    }
    ...
    public function validateCreate($data)
    {
        ...
        [
            'title.required' => 'Please provide education',
            'title.alpha_spaces' => 'Education name may only contain letters and spaces',
            'title.unique' => 'The education has already been taken'
        ]);
    }
    ...
    public function getEducationByName($education)
    {
        return ServiceModel::whereTitle($education)->first();
    }
