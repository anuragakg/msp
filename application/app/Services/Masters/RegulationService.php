...
use App\Models\Masters\Regulation as ServiceModel;
...
class RegulationService extends Service
{
    ...
    public function validateCreate($data)
    {
        ...
        [
            'title.required' => 'Please provide regulation',
            'title.alpha_spaces' => 'Regulation name may only contain letters and spaces',
            'title.unique' => 'The regulation has already been taken'
        ]);
    }
    ...
    public function getRegulationByName($name)
    {
