...
use App\Models\Masters\Periodicity as ServiceModel;
use Illuminate\Support\Facades\Validator;
use Illuminate\Validation\Rule;

class PeriodicityMasterService extends Service
{
    /**
    ...
    public function validateCreate($data)
    {
        ...
        [
            'title.required' => 'Please provide periodicity',
            'title.alpha_spaces' => 'Periodicity name may only contain letters and spaces',
            'title.unique' => 'The periodicity has already been taken'
        ]);
    }
