...
use App\Models\Masters\Level as ServiceModel;
...
class LevelService extends Service
{
    ...
    public function validateCreate($data)
    {
        ...
        return Validator::make($data, [
            ...
            'slug' => 'required|unique:levels_master,slug,'.$data['slug'],
            'description' => 'required'
        ],
            [
                'title.required' => 'Please provide level',
                'title.unique' => 'Level has already been taken',
                'slug.required' => 'Please provide slug',
