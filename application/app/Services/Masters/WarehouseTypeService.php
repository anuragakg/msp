...
use App\Models\Masters\WarehouseType as ServiceModel;
use Illuminate\Support\Facades\Validator;
use Illuminate\Validation\Rule;

class WarehouseTypeService extends Service
{
    /**
    ...
    public function validateCreate($data)
    {
        ...
        [
            'title.required' => 'Please provide warehouse type',
            'title.alpha_spaces' => 'Warehouse type name may only contain letters and spaces',
            'title.unique' => 'The warehouse type has already been taken'
        ]);
    }
