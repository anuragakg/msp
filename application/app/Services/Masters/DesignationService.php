...
use App\Models\Masters\Designation as ServiceModel;
...
class DesignationService extends Service
{
    ...
    public function createItem($data)
    {
        ...
        $item->save();
        //==Add User Activity
        $activity='added designation master  '.$data['title'];
        $module='master';
    ...
    public function updateItem($id, $data)
    {
        ...
        $item->save();
        //==Add User Activity
        $activity='updated designation master  '.$data['title'];
        $module='master';
        $this->addUserActivity($activity,$module);
        return $item;
    }
    ...
    public function validateCreate($data)
    {
        ...
        [
            'title.required' => 'Please provide designation',
            'title.alpha_spaces' => 'Designation name may only contain letters and spaces',
    ...
    {
        return ServiceModel::whereTitle($designation)->first();
    }
