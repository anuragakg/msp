 ...
 * 2. Mail
 */
class InfrastructureConsolidationAssignNextLevel extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
            ...
            ->subject('Infrastructure Development Consolidation ID '.$this->reference_number.' Assigned ' )
            ->line('Dear Sir/Madam,')
            ->line('Greetings!!,')
    ...
    {
        $this->action .= "proposal-verification/infrastructure-development-verification.php?tab=4";
