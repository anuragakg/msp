...
$("#nodal-list").hide();
    $("#sia-list").show();
    html="<tr><td colspan='8'>No Data Found here!</td></tr>";
    $("#show").html(html);
}
if(auth.role == 4){ //if logged in user is nodal
    $("#nodal-list").show();
    $("#sia-list").hide();
    $(document).ready(function () {
        ...
        var oTable = $('#list').DataTable({
            ...
            "buttons": [
                {
                    ...
                    titleAttr: 'EXCEL',
                    title: 'Infrastructure release fund list',
                    exportOptions: {
            ...
            "ajax": {
                "url": conf.getInfrastructureReleaseList.url,
                "dataType": "json",
                "type": "GET",
                "headers": {
            ...
            "columns": [
                ...
                },
                {
                        ...
                        if(parseFloat(row.balance_amount)>0)
                    {
                        ...
                        {
                            html += '<a href="../fund-management/infrastructure_release_fund-form.php?id='+row.id+'" class="btn btn-primary">Release Fund</a>';
                        }
                    }
                    html += '<a href="../fund-management/infrastructure_release_fund_details.php?id='+row.id+'" class="btn btn-primary">View Details</a>';
                   return html;
                    }
                },
     ...
     $('.dataTables_filter input').attr("placeholder", "Serach by Consolidate Id");
    });
}
        ...
        var oTable = $('#list').DataTable({
            ...
            "columns": [
             ...
             
                {
                    "orderable": false,
                    "render": function (data, type, row) {
                        return utils.formatAmount(row.max_can_release);
                    },
                "className": "text-right"
                },
                {
