...
var msp_market_price_edit = TRIFED.checkPermissions("msp_market_price_edit");
...
$(document).ready(function () {
    ...
    var oTable = $('#list').DataTable({
        ...
        "ajax": {
            "url": conf.getPendingMspMarketPriceList.url,
            "dataType": "json",
            "type": "GET",
            "headers": {
        ...
        "columns": [
            ...
            
            {
                ...
                "render": function (data, type, row) {
                    ...
                    if(msp_market_price_edit && (status==0 || status==2))
                    {
