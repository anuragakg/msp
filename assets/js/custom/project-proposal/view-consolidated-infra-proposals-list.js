...
var editProposal = TRIFED.checkPermissions("infrastructure_development_edit");
var viewProposal = TRIFED.checkPermissions("infrastructure_development_view");
var addProposal = TRIFED.checkPermissions("infrastructure_development_add");
var statusProposal = TRIFED.checkPermissions("infrastructure_development_status");
//console.log(auth);
//alert(editProposal);
		...
		"buttons": [
			{
				...
				titleAttr: 'EXCEL',
				title: 'View Consolidated Proposal List',
				exportOptions: {
            ...
            "ajax":{
                     "url": conf.getConsolidatedInfraProposalsList.url,
                     "dataType": "json",
                     "type": "GET",
                     "headers": {
		            ...
		            "columns": [
						...
						{ 
							"render": function(data, type, row) {
								var html='';						      
						        	html += ' <a href="../modification-infrastructure/verification-sia-level.php?id='+row.ref_id+'&proposal_id='+row.proposal_id+'" class="data-edit"><i class="fa fa-eye" title="View Detail"></i></a>';		
						      	return html;
						    }
						},
