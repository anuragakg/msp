...
$(document).ready(function () {
	...
	var oTable = $('#list').DataTable({
		...
		"buttons": [
            ...
            "ajax":{
                     "url": conf.getConsolidatedProposalsList.url,
                     "dataType": "json",
                     "type": "GET",
                     "headers": {
		            ...
		            "columns": [
						...
						{ 
							"orderable": false,
		                	"render": function(data, type, row) {
		                		return row.current_status_text+'<br><span ><i class="fa fa-line-chart" onclick="getMfpProcurementStatusLogs('+row.id+')")"></i></span>';
						...
						{ 
							"render": function(data, type, row) {
								var html='';
						        	...
						        	html += ' <a href="../proposal-verification/verification-details.php?id='+row.ref_id+'&proposal_id='+row.proposal_id+'" class="data-edit"><i class="fa fa-eye" title="View Detail"></i></a>';		
